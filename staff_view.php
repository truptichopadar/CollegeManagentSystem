			...
			<div id="section">
				...
				<div class="content1">
						...
						<table border="1px">
							...
							<tr><th>Faculty Name </th> <td> <?php echo $row["TNAME"]; ?></td></tr>
							<tr><th>Qualification </th> <td> <?php echo $row["QUAL"]; ?></td></tr>
							<tr><th>Faculty Id </th> <td> <?php echo $row["FID"]; ?></td></tr>
							<tr><th>Designation </th> <td> <?php echo $row["POST"]; ?></td></tr>
